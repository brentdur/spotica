...
CACHES = {
    'default': {
        ...
        'LOCATION': 'spotica-cache.bv78qc.0001.use1.cache.amazonaws.com:6379',
    },
}
...
STATIC_ROOT = '/var/apps/spotica/web/scalica/static'
MEDIA_ROOT = '/var/apps/spotica/web/scalica/media/'
MEDIA_URL = '/media/'
...
CELERY_BROKER_URL = 'redis://spotica-cache.bv78qc.0001.use1.cache.amazonaws.com:6379/1'
